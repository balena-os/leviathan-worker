...
* qemu: disable serial logging when debug is enabled [Joseph Kogut]
* entry: skip creation of existing device nodes [Joseph Kogut]
* config: default: standardize boolean parsing [Joseph Kogut]
