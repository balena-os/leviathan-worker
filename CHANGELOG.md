...
* Update debian Docker tag to bookworm-20260713 [balena-renovate[bot]]

# v2.10.40
## (2026-07-23)

* Update body-parser to v1.20.6 [SECURITY] [balena-renovate[bot]]

# v2.10.39
## (2026-07-23)

* Update @balena/node-serial-terminal to ^0.0.3 [balena-renovate[bot]]
...
* Update @balena/node-qmp to ^0.0.6 [balena-renovate[bot]]

# v2.10.36
## (2026-07-23)

* lib/index.ts: write segmented image chunks at their byte offset [guille-vega]

# v2.10.35
## (2026-07-03)

* lib/index.ts: Add support for segmented OS image upload in sendImage [Florin Sarbu]

# v2.10.34
## (2026-07-03)

* workflows: remove BM push [Ryan Cooke]
...
* Update debian Docker tag to bookworm-20260518 [balena-renovate[bot]]
...
* autokit: add custom board power routine [Ryan Cooke]
...
* enable configurable flashing timeout [Ryan Cooke]
...
* run e2e tests on self hosted runners [Ryan Cooke]

# v2.10.17
## (2025-12-01)

* Update actions/checkout digest to 93cb6ef [balena-renovate[bot]]
